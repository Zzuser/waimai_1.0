...
<ul class="mui-table-view mui-table-view-chevron">
    <li class="mui-table-view-cell">
        <a  class="mui-navigate-right">总销售额</a>
        <a class="mui-pull-left">dfsfd</a>
    </li>
    <li class="mui-table-view-cell">
        <a  class="mui-navigate-right">总销量</a>
    </li>
    <li class="mui-table-view-cell">
        <a class="mui-navigate-right">月销售额</a>
    </li>
    <li class="mui-table-view-cell">
        <a class="mui-navigate-right">月销量</a>
    </li>
</ul>
<ul class="mui-table-view mui-table-view-chevron">
    <li class="mui-table-view-cell">
